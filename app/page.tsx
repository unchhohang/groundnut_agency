...
export default function Home() {
  return (
    <div className="min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
        ...
        <div className="nav-bar flex gap-6 justify-center items-center" >
        ...
        <div>
          <div className="text-6xl font-bold">We design your vision and build it to reality</div>
        ...
        <div>
          ...
          <Image src={'/assets/testi/Rishav.jpeg'} width={500} height={700} alt="Testomnial Rishav Picture" />
        </div>
