      ...
      <div className="relative z-100">
        ...
        text-white">We speak both <br /> design <br /> and code</div>
          ...
          <div className="px-5">
            ...
            <div className="choose-us-testo-mobile my-20 tablet:hidden">
              <Image src={'/assets/why_choose_us.jpeg'} width={500} height={500} alt="Why choose us lady picture"
                ...
                style={{ borderRadius: '24px' }}
              />
              <div className="mobile-view flex flex-col gap-2 my-1 p-5 pr-10 text-left relative bottom-10 ">
                <div className="flex ">
                  <StarIcon weight="fill" color="#ffffff" />
                  <StarIcon weight="fill" color="#ffffff" />
                  <StarIcon weight="fill" color="#ffffff" />
         ...
         px-5  bg-linear-to-b from-secondary from-50% to-black " id="features">
          ...
          <div className="Pricing-section flex flex-col items-center my-20 p-10" id="pricing">
            <div className="rounded-full border border-solid border-gray-50/10 text-white text-body-xxs
        ...
        <footer
          className="hidden tablet:block bg-black  sticky z-20 bottom-0"
        >
          <div className="   ">
            <video autoPlay loop muted preload="none "
              className="w-full z-10 relative mask-t-from-40% mask-t-to-95% mask-b-from-40% mask-b-to-95% "
            >
              <source src="/assets/footer_bg_video.mp4" type="video/mp4" />
              Your browser does not support the video tag.
            </video>
            <div className="absolute top-[50%] -translate-y-[50%] left-[50%] -translate-x-[50%] flex flex-col items-center gap-4 z-50">
              <div className=" font-medium text-7xl text-center tracking-tighter leading-20
        text-white whitespace-nowrap">Are you&nbsp;
                <span className="font-instru italic text-white text-7xl font-medium text-center tracking-tight">
                  ready?
                </span>
              </div>
              <div className=" text-center text-body-l ">This could be start of something big.</div>
              <CTABtn text="Book a call" textSize="big" />
            </div>
          </div>
        </footer>
      </div>
